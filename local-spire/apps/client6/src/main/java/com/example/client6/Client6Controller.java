...
@RestController
public class Client6Controller {

    private static final Logger LOGGER = LoggerFactory.getLogger(Client6Controller.class);

    private final WebClient backendClient;

    public Client6Controller(
    ...
    public Mono<String> hello() {
        return Mono.just("Hello, World! (from client6)");
    }
